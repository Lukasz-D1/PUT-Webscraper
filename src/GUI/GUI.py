...
class WebscrapperGUI:
    ...
    def start(self):
        ...
        EntryURLInput = tkinter.Entry(frame_url_input, width=60, textvariable=stringURL)
        ...
        ButtonGetSubpages = tkinter.Button(frame_subpages, text="Scrap subpages",
                                           command=lambda: self.get_subpages_from_textbox(stringURL.get(),
        ...
        ButtonGetImages = tkinter.Button(frame_images, text="Get images",
                                         command=lambda: self.get_images_from_textbox(stringURL.get(), "images/",
